...
-- 3-
UPDATE employee set id = 1 WHERE id = NULL;
UPDATE employee SET id = (id*2) WHERE id < 10;
UPDATE employee set name = 'A' WHERE name LIkE 'A%';
UPDATE employee set name = 'B' WHERE name LIkE 'B%';
UPDATE employee set name = 'B' WHERE name LIkE 'C%';

-- 4-)
DELETE FROM employee WHERE name = '%a';
DELETE FROM employee WHERE name = 'C%';
